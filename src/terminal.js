...
let terminal_text_ident = '&gt; ';
let terminal_text_title = '' +
	'ALIENXSHIP\n' +
	'__ \n' +
	'CONCEPT, GRAPHICS &AMP; PROGRAMMING:\n' +
	'SUNRISE HACK // PHOBOSLAB.ORG\n' +
	'__ \n' +
	'MUSIC:\n' +
...
function terminal_run_garbage(callback) {
	...
	for (let i = 0; i < 64; i++) {
		let s = (_math.random()*length)|0;
		let e = (_math.random()*(length - s))|0;
